...
def recognize(path):
    ...
    print("np.array(pooling_layer3.flatten()\n", len(np.array(pooling_layer3.flatten(), ndmin=2)[0]))
    ...
    if (max_output_index == 0):
        text =  "На данном рентгене изображен другой вид перелома"
    elif (max_output_index == 1):
        text =  "На данном рентгене изображен косой вид перелома"
    elif max_output_index == 2:
        text =  "На данном рентгене изображен поперечный вид перелома"
    elif max_output_index == 3:
        text =  "На данном рентгене изображен продольный вид перелома"
    elif max_output_index == 4:
        text =  "На данном рентгене изображен винтоообразный вид перелома"
    return text
