...
def recognize(path):
    ...
    if (max_output_index == 0):
        text =  "На данном рентгене изображен череп"
    elif (max_output_index == 1):
        text =  "На данном рентгене изображена верхняя/нижняя конечность"
    elif max_output_index == 2:
        text =  "На данном рентгене изображено туловище"
    return text
